...
\documentclass[11pt,a4paper,sans]{moderncv}   %chosen template    
\moderncvstyle{casual}                        %style of cv               
\moderncvcolor{blue}                          %colour of format  

\usepackage{lipsum}                           %Loading Font
\usepackage[scale=0.75]{geometry}             %Margins
\usepackage{array}
...
\photo[80pt][0.5pt]{manish_pp.JPG}

\mobile{9892284187 , 9930776667}

\email{manishdsilva7@gmail.com}

\address{RK Mandir Road,Kondivita}{Andheri East}{Mumbai 400059}
...
\begin{itemize}
\item To serve the Nation and help gaining its Prosperity by Devolepment in Technology

\item To Critically Analyze Problems of the Society through Logical Reasoning and Build Solutions \\
...
\begin{tabular}{|P{3cm}|P{4.5cm}|P{3.5cm}|P{3cm}|P{3cm}|}
	...
	B.Tech(EXTC)& Sardar Patel Institute Of Technology & Mumbai University(Autonomous) & pursuing & 9.91 CGPA (Upto Sem 3)  \\ \hline
	H.S.C (12th) & PACE Powai & Maharashtra State Board & 2017  & 90.31\%  \\ \hline
	S.S.C (10th) & St John The Evangelist Marol & Maharashtra State Board & 2015 & 93.4\%  \\  \hline
	
\end{tabular}
\newline\newline
\textbf{EXTC => Electronics \& Telecommunication Engineering}
